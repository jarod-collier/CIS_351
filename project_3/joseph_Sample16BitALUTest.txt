 ...
 */
public class joseph_Sample16BitALUTest {
  ...
  @Test
    public void testSubbu() {
      setPinUnsigned("InputA", 65000);
      setPinUnsigned("InputB", 64999);
      setPinUnsigned("Op", OpCodes.SUBU);
      run();
      Assert.assertEquals("Subtraction Output", (65000 - 64999), readPinUnsigned("Output"));
  ...
  @Test
   public void testXor() {
    setPinUnsigned("InputA", 65000);
    setPinUnsigned("InputB", 60000);
    setPinUnsigned("Op", OpCodes.XOR);
    run();
    Assert.assertEquals("XOR Output", 6024, readPinSigned("Output"));
  ...
  @Test
    public void testNot() {
     ...
     run();
     Assert.assertEquals("NOT Output", 535, readPinSigned("Output"));
     Assert.assertEquals("NOT Overflow", false, readPin("Overflow"));
    }

  @Test
     public void testLUI() {
      setPinUnsigned("InputA", 65111);
      setPinUnsigned("Op", OpCodes.LUI);
      run();
      Assert.assertEquals("LUI Output", 22272, readPinSigned("Output"));
